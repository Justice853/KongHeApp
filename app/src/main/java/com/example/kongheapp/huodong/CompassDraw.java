...
public class CompassDraw extends View {
    ...
    public CompassDraw(Context context, @Nullable AttributeSet attrs){
        this(context,attrs,0);

    }
    public CompassDraw(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
